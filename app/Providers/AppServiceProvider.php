...
use App\Policies\AssetCustodianPolicy;
use App\Policies\AssetCustomFieldDefinitionPolicy;
use App\Policies\AssetModelPolicy;
use App\Policies\AssetMovementDocumentPolicy;
use App\Policies\AssetMovementPolicy;
...
class AppServiceProvider extends ServiceProvider
{
    ...
    public function boot(): void
    {
        ...
        Gate::policy(AssetCustodian::class, AssetCustodianPolicy::class);
        Gate::policy(AssetMovement::class, AssetMovementPolicy::class);
        Gate::policy(AssetMovementDocument::class, AssetMovementDocumentPolicy::class);
