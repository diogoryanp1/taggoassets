...
@php($nav = $currentTenant ? [
    ['group' => 'Visao Geral', 'items' => [['label' => 'Visao Geral', 'route' => 'dashboard', 'can' => ['viewAny', \App\Domain\Assets\Models\Asset::class]]]],
    ['group' => 'Patrimonio', 'items' => [['label' => 'Ativos', 'route' => 'assets.index', 'can' => ['viewAny', \App\Domain\Assets\Models\Asset::class]], ['label' => 'Categorias', 'route' => 'catalog.categories.index', 'can' => ['viewAny', \App\Domain\Assets\Models\AssetCategory::class]], ['label' => 'Tipos', 'route' => 'catalog.types.index', 'can' => ['viewAny', \App\Domain\Assets\Models\AssetType::class]], ['label' => 'Marcas', 'route' => 'catalog.brands.index', 'can' => ['viewAny', \App\Domain\Assets\Models\AssetBrand::class]], ['label' => 'Modelos', 'route' => 'catalog.models.index', 'can' => ['viewAny', \App\Domain\Assets\Models\AssetModel::class]]]],
    ['group' => 'Estrutura', 'items' => [['label' => 'Unidades Administrativas', 'route' => 'units.index', 'can' => ['viewAny', \App\Domain\Organizations\Models\OrganizationalUnit::class]], ['label' => 'Localizacoes', 'route' => 'locations.index', 'can' => ['viewAny', \App\Domain\Organizations\Models\Location::class]], ['label' => 'Unidades de Medida', 'route' => 'catalog.units.index', 'can' => ['viewAny', \App\Domain\Assets\Models\UnitOfMeasure::class]], ['label' => 'Estados de Conservacao', 'route' => 'catalog.conditions.index', 'can' => ['viewAny', \App\Domain\Assets\Models\AssetCondition::class]]]],
    ['group' => 'Administracao', 'items' => [['label' => 'Usuarios', 'route' => 'users.index', 'can' => ['viewAny', \App\Models\User::class]], ['label' => 'Convites', 'route' => 'invitations.index', 'can' => ['viewAny', \App\Models\User::class]], ['label' => 'Auditoria', 'route' => 'audit.index', 'can' => ['viewAny', \App\Domain\Audit\Models\AuditLog::class]]]],
    ['group' => 'Configuracoes', 'items' => [['label' => 'Campos Customizados', 'route' => 'catalog.custom-fields.index', 'can' => ['viewAny', \App\Domain\Assets\Models\AssetCustomFieldDefinition::class]]]],
] : [])
